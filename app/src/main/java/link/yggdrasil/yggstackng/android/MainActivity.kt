package link.yggdrasil.yggstackng.android
...
import link.yggdrasil.yggstackng.android.data.ServiceStartMode
import link.yggdrasil.yggstackng.android.data.VersionChecker
import link.yggdrasil.yggstackng.android.data.VersionInfo
import link.yggdrasil.yggstackng.android.service.PeerFetcherService
import link.yggdrasil.yggstackng.android.service.YggstackConfigParcelable
import link.yggdrasil.yggstackng.android.service.YggstackService
import link.yggdrasil.yggstackng.android.ui.configuration.ConfigurationScreen
import link.yggdrasil.yggstackng.android.ui.configuration.ConfigurationViewModel
import link.yggdrasil.yggstackng.android.ui.configuration.PendingDeepLink
import link.yggdrasil.yggstackng.android.ui.diagnostics.DiagnosticsScreen
import link.yggdrasil.yggstackng.android.ui.settings.SettingsScreen
import link.yggdrasil.yggstackng.android.ui.theme.YggstackAndroidTheme
import link.yggdrasil.yggstackng.android.utils.LocaleHelper
import link.yggdrasil.yggstackng.android.utils.PermissionHelper
...
class MainActivity : ComponentActivity() {
    ...
    private fun registerAutomationShortcuts() {
        val startShortcut = ShortcutInfoCompat.Builder(this, "shortcut_start_yggstack")
            ...
            .setIntent(
                Intent(this, link.yggdrasil.yggstackng.android.automation.AutomationStartActivity::class.java)
        ...
        val stopShortcut = ShortcutInfoCompat.Builder(this, "shortcut_stop_yggstack")
            ...
            .setIcon(IconCompat.createWithResource(this, R.mipmap.ic_launcher))
            .setIntent(
                Intent(this, link.yggdrasil.yggstackng.android.automation.AutomationStopActivity::class.java)
                    .setAction(Intent.ACTION_DEFAULT)
            )
            .build()
                ...
                if (bundledResult.isSuccess) {
                    ...
                    if (bundledPeers.isNotEmpty()) {
                        configRepository.savePublicPeersCache(
                            link.yggdrasil.yggstackng.android.data.PublicPeersCache(
                                peers = bundledPeers,
